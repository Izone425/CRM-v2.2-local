...
namespace App\Filament\Customer\Resources\ImplementerTicketResource\RelationManagers;
...
class RepliesRelationManager extends RelationManager
{
    ...
    {
        return $table
            ->modifyQueryUsing(fn (Builder $query) => $query->where('is_internal_note', false))
            ->columns([

...
class TrainingRequestTrainer1 extends Page
{
    protected static ?string $navigationIcon = 'heroicon-o-calendar-days';
    protected static ?string $navigationLabel = 'Training Request Trainer 1';
    protected static ?string $title = '';
    protected static string $view = 'filament.pages.training-request-trainer1';
    protected static ?int $navigationSort = 62;

    // Trainer is fixed for this page
    public string $selectedTrainer = 'TRAINER_1';

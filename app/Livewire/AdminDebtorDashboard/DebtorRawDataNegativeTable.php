...
class DebtorRawDataNegativeTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.admin-debtor-dashboard.debtor-raw-data-negative-table');
    }
}

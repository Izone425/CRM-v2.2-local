...
class ProjectFollowUpOne extends Component implements HasForms, HasTable
{
    ...
    public function getOverdueHardwareHandovers()
    {
        ...
        $query =  SoftwareHandover::query()
            ...
            ->where('manual_follow_up_count', 1)
    ...
    {
        return view('livewire.implementer_dashboard.project-follow-up-one');
    }

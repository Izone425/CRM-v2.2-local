...
class ImplementerRequestRejected extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.implementer_dashboard.implementer-request-rejected');
    }
}

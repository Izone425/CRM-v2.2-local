...
class ImplementerProjectInactive extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.implementer_dashboard.implementer-project-inactive');
    }
}

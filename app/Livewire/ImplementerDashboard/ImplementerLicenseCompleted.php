...
class ImplementerLicenseCompleted extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.implementer_dashboard.implementer-license-completed');
    }
}

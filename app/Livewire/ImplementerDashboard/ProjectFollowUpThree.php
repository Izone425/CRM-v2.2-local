...
class ProjectFollowUpThree extends Component implements HasForms, HasTable
{
    ...
    public function getOverdueHardwareHandovers()
    {
        ...
        $query =  SoftwareHandover::query()
            ...
            ->where('manual_follow_up_count', 3)
    ...
    {
        return view('livewire.implementer_dashboard.project-follow-up-three');
    }

...
class HrdfAttLogAllTable extends Component implements HasTable, HasForms
{
    ...
    {
        return $table
            ->query($this->getAllHrdfAttendanceLogs())
    ...
    {
        return view('livewire.admin-h-r-d-f-attendance-log.hrdf-att-log-all-table');
    }
}

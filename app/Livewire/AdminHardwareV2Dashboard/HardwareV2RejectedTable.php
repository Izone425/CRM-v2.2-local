...
class HardwareV2RejectedTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.admin-hardware-v2-dashboard.hardware-v2-rejected-table');
    }
}

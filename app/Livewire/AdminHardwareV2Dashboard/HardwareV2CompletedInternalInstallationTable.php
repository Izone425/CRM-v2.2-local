...
class HardwareV2CompletedInternalInstallationTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.admin-hardware-v2-dashboard.hardware-v2-completed-internal-installation-table');
    }
}

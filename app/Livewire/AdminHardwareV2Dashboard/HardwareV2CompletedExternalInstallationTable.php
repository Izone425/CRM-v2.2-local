...
class HardwareV2CompletedExternalInstallationTable extends Component implements HasForms, HasTable
{
    ...
    public function getNewHardwareHandovers()
    {
        return HardwareHandoverV2::query()
            ->whereIn('status', ['Completed: External Installation'])
    ...
    {
        return view('livewire.admin-hardware-v2-dashboard.hardware-v2-completed-external-installation-table');
    }
}

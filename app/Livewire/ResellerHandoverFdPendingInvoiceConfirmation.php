...
class ResellerHandoverFdPendingInvoiceConfirmation extends Component
{
    use WithFileUploads;
    ...
    {
        $handover = ResellerHandoverFd::find($handoverId);
    ...
    {
        return view('livewire.reseller-handover-fd-pending-invoice-confirmation', [

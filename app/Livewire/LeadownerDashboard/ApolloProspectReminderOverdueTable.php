...
class ApolloProspectReminderOverdueTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.leadowner_dashboard.apollo-prospect-reminder-overdue-table');
    }
}

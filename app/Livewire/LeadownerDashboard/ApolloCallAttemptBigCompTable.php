...
class ApolloCallAttemptBigCompTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.leadowner_dashboard.apollo-call-attempt-big-comp-table');
    }
}

...
class AdminRepairCompletedAdmin extends Component implements HasForms, HasTable
{
    ...
    public function getTableQuery(): Builder
    {
        $query = AdminRepair::query()
            ->where('status', 'Completed Admin Repair')
    ...
    {
        return view('livewire.admin-repair-completed-admin');
    }
}

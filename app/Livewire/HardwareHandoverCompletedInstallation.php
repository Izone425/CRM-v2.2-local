...
class HardwareHandoverCompletedInstallation extends Component implements HasForms, HasTable
{
    ...
    public function getOverdueHardwareHandovers()
    {
        return HardwareHandover::query()
            ->whereIn('status', ['Completed: Installation'])
    ...
    {
        return view('livewire.hardware-handover-completed-installation');
    }
}

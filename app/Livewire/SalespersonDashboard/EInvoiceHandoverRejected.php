...
class EInvoiceHandoverRejected extends Component implements HasForms, HasTable
{
    ...
    public function getRejectedEInvoiceHandovers()
    {
        $user = auth()->user();
    ...
    {
        return $table
            ->query($this->getRejectedEInvoiceHandovers())
    ...
    {
        return view('livewire.salesperson-dashboard.e-invoice-handover-rejected');
    }
}

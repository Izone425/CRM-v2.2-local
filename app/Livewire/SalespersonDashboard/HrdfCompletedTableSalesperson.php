...
class HrdfCompletedTableSalesperson extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson-dashboard.hrdf-completed-table-salesperson');
    }
}

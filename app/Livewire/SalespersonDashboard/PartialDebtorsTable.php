...
class PartialDebtorsTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_dashboard.partial-debtors-table');
    }
    ...
    protected function getBaseQuery()
    {
        ...
        // Filter for partial payment debtors
    ...
    {
        // For this table, all records have partial payment
            ...
            ->columns([
                ...
                TextColumn::make('paid_amount')
                    ...
                    ->getStateUsing(function (DebtorAging $record): float {
                        $paidAmount = $record->invoice_amount - $record->outstanding;
                        return $record->currency_code === 'MYR'
                            ? $paidAmount
                            : ($paidAmount * $record->exchange_rate);
                    })
                    ->money('MYR')
                    ->alignRight(),
                ...
                TextColumn::make('invoice_amount')
                    ...
                    ->getStateUsing(function (DebtorAging $record): float {
                        return $record->currency_code === 'MYR'
                            ...
                            : ($record->invoice_amount * $record->exchange_rate);
                    })
                    ->money('MYR')
                    ->alignRight(),
            ])

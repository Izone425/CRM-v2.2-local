...
class HrdfDebtorsTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_dashboard.hrdf-debtors-table');
    }

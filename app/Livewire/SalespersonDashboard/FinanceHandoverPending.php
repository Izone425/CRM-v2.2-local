...
class FinanceHandoverPending extends Component implements HasForms, HasTable
{
    ...
    {
        return $table
            ->query($this->getPendingFinanceHandovers())
            ...
            ->columns([
                ...
                TextColumn::make('status')
                    ...
                    ->formatStateUsing(fn(string $state): HtmlString => match ($state) {
                        'New' => new HtmlString('<span style="color: #3b82f6;">New</span>'),
                        'Pending Payment' => new HtmlString('<span style="color: #f59e0b;">Pending Payment</span>'),
    ...
    {
        return view('livewire.salesperson-dashboard.finance-handover-pending');
    }
}

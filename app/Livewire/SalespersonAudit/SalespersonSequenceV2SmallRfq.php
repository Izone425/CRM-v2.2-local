...
class SalespersonSequenceV2SmallRfq extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_audit.salesperson-sequence-v2-small-rfq');
    }
}

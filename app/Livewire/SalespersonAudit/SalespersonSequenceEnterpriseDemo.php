...
class SalespersonSequenceEnterpriseDemo extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_audit.salesperson-sequence-enterprise-demo');
    }
}

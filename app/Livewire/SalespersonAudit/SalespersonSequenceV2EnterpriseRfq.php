...
class SalespersonSequenceV2EnterpriseRfq extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_audit.salesperson-sequence-v2-enterprise-rfq');
    }
}

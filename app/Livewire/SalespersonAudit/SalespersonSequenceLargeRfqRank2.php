...
class SalespersonSequenceLargeRfqRank2 extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_audit.salesperson-sequence-large-rfq-rank2');
    }
}

...
class SalespersonSequenceMediumDemoRank2 extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_audit.salesperson-sequence-medium-demo-rank2');
    }
}

...
class SalespersonSequenceV2LargeDemo extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_audit.salesperson-sequence-v2-large-demo');
    }
}

...
class SalespersonSequenceV2LargeRfq extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.salesperson_audit.salesperson-sequence-v2-large-rfq');
    }
}

...
class GenerateInvoiceResellerPortalFinance extends Component implements HasTable, HasForms
{
    ...
    {
        return view('livewire.finance-invoice.generate-invoice-reseller-portal-finance');
    }
}

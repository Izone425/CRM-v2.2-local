...
class FinanceHandoverDraftTable extends Component implements HasForms, HasTable
{
    ...
    public function getDraftFinanceHandovers()
    {
    ...
    public function table(Table $table): Table
    {
        return $table
            ->poll('300s')
            ->query($this->getDraftFinanceHandovers())
    ...
    {
        return view('livewire.admin-finance-dashboard.finance-handover-draft-table');
    }
}

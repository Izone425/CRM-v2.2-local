...
class FinanceHandoverRejectedTable extends Component implements HasForms, HasTable
{
    ...
    {
        return view('livewire.admin-finance-dashboard.finance-handover-rejected-table');
    }
}

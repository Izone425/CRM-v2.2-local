<!-- filepath: /var/www/html/timeteccrm/resources/views/livewire/reseller/login.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Login Your TimeTec Reseller Account</title>
    ...
    <div class="flex flex-col items-center justify-center min-h-screen">
        <div class="w-full max-w-2xl mx-auto mt-8 overflow-hidden bg-white shadow-lg rounded-3xl">
            ...
            <div class="px-8 py-10">
                ...
                <form class="space-y-6" action="{{ route('reseller.login.submit') }}" method="POST">
                    @csrf
                    <div>

                    ...
                    <tr>
                        <td>
                            <button
                                ...
                                class="text-sm font-semibold text-yellow-600 transition-colors cursor-pointer hover:text-yellow-800">

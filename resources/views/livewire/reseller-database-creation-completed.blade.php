                    ...
                    <tr>
                        <td>
                            <button
                                ...
                                class="text-sm font-semibold text-green-600 transition-colors cursor-pointer hover:text-green-800">
                        ...
                        <td class="text-gray-500">
                            {{ \Carbon\Carbon::parse($request->completed_at)->format('M d, Y H:i') }}
                        </td>
                    </tr>
                @empty
                    <tr>

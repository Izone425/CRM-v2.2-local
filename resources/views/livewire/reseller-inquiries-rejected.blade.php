            ...
            <tbody>
                @forelse($inquiries as $inquiry)
                    <tr>
                        ...
                        <td>
                            <button
                                wire:click="convertToDraft({{ $inquiry->id }})"
                                class="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-all">
                                <i class="fas fa-redo"></i>Convert to Draft
                            </button>
                        </td>
                    </tr>
                @empty

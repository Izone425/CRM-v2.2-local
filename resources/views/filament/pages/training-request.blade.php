<x-filament-panels::page>
    <div class="training-request-container">
        {{-- STEP 1: Choose Trainer and Year --}}
        <div class="selection-header">
            <div class="selection-card">
                ...
                <div class="selection-content">
                    <span class="selection-step">Step 1</span>
                    <h3 class="selection-title">Choose Trainer</h3>
                    <div class="trainer-selection">
                        @foreach($trainers as $key => $label)
                            <label class="option-pill {{ $selectedTrainer === $key ? 'selected' : '' }}">
            ...
            <div class="selection-card">
                ...
                <div class="selection-content">
                    <span class="selection-step">Step 2</span>
                    <h3 class="selection-title">Choose Year</h3>
                    <div class="year-selection">
                        @foreach($years as $year)
                            <label class="option-pill {{ $selectedYear === $year ? 'selected' : '' }}">
            ...
            <div class="sessions-container">
                <div class="sessions-header">
                    <div class="sessions-header-content">
                        <h2 class="sessions-title">Training Sessions - {{ $trainers[$selectedTrainer] ?? $selectedTrainer }}</h2>
                        <p class="sessions-subtitle">Step 3: Select a session to view details or add training requests</p>
                    </div>

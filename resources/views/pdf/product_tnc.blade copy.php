    ...
    <div style="margin-top:275px;border-top:1px solid #000;padding-top:10px;">
    ...
    <table style="width: 100%;">
        <tr>
            <td colspan="2">
                By signing below, I have confirmed that I have read above terms and conditions from item number 1 to item number 28. It would automatically be deemed as an incorporated terms and conditions in this quotation proposal.
            </td>
        </tr>
        <tr>
            <td style="height: 150px;">
                <div class="pull-left" style="padding-top:30px;">
                    ...
                    <div><span style="font-weight:bold;">H/P No: </span>{{ $quotation->sales_person->mobile_no }}</div>
                </div>
            </td>
            <td style="height: 150px">

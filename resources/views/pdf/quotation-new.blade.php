...
<main style="margin-top:275px;">
    <table class="table table-bordered" style="border-color: #005baa;">
        ...
        <tbody>
            ...
            @if($quotation->quotation_type == 'hrdf' && ($loop->iteration == 2 || $loop->iteration == 4 || $loop->iteration == 6 || $loop->iteration == 8 || $loop->iteration == 10))
                        <tr style="border-color: #000;">
                            <td class="text-center" style="width:20px; border-color:#000;">{{ ++$i }}</td>
                            <td style="border-color:#000;">{!! $description !!}</td>
                ...
                <table class="table table-bordered" style="border-color: #005baa;">
                    ...
                    <tbody>
            @elseif($quotation->quotation_type == 'product' && ($loop->iteration == 3 || $loop->iteration == 6 || $loop->iteration == 9 || $loop->iteration == 12 || $loop->iteration == 15))
                <tr style="border-color: #000;">
                    <td class="text-center" style="width:20px; border-color:#000;">{{ ++$i }}</td>
                    <td style="border-color:#000;">{!! $description !!}</td>
                    <td class="text-center" style="border:1px solid #000">{{ $item->quantity }}</td>
